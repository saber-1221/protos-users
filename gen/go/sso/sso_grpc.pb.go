...
const (
	...
	SSO_IsInvalidToken_FullMethodName = "/sso.SSO/IsInvalidToken"
)
...
type SSOClient interface {
	...
	IsInvalidToken(ctx context.Context, in *IsInvalidTokenRequest, opts ...grpc.CallOption) (*IsInvalidTokenResponse, error)
}
...
func (c *sSOClient) IsInvalidToken(ctx context.Context, in *IsInvalidTokenRequest, opts ...grpc.CallOption) (*IsInvalidTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsInvalidTokenResponse)
	err := c.cc.Invoke(ctx, SSO_IsInvalidToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SSOServer interface {
	...
	IsInvalidToken(context.Context, *IsInvalidTokenRequest) (*IsInvalidTokenResponse, error)
...
func (UnimplementedSSOServer) IsInvalidToken(context.Context, *IsInvalidTokenRequest) (*IsInvalidTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IsInvalidToken not implemented")
}
...
func _SSO_IsInvalidToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsInvalidTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SSOServer).IsInvalidToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SSO_IsInvalidToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SSOServer).IsInvalidToken(ctx, req.(*IsInvalidTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SSO_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IsInvalidToken",
			Handler:    _SSO_IsInvalidToken_Handler,
		},
	},
